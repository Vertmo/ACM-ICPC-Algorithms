"""
Simplex Algorithm, used to find a solution given a set of linear constraint
"""
...
if __name__ == '__main__':
    t = Tableau([-2,-3,-2])             # max z = 2x + 3y + 2z
    t.add_constraint([2, 1, 1], 4)      # 2x + y + z <= 4
    t.add_constraint([1, 2, 1], 7)      # x + 2y + z <= 7
    t.add_constraint([0, 0, 1], 5)      # z          <= 5
    t.solve()
